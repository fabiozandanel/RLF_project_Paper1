...
\caption{X-ray and SZ scaling relations. Grey triangles show the MultiDark
  ...
  $Y_{\rmn{SZ}}-M_{500}$ scaling relation at $z=0.18$ in comparison
  to the observational sample by the \protect\cite{2013arXiv1303.5080P} with a 
  median redshift of $0.18$. The bottom panels show the relative difference to
...
at the MultiDark snapshot $z=0.18$ (that contains 11105 clusters 
above our mass cut) which however is not used throughout the rest of the work}. Our
