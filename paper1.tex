...
{\bf In the right panel of Fig.~\ref{fig:SZ_M}, we compare our scaling relation
  ...
  $Y_{500}$ estimates. This could also indicate that our presented model is too
  simplistic to capture the rich cluster physics and potentially may even signal
  ...
  relation at $z=0.53$ ($A=-27.67\pm0.11$, $B=1.59\pm0.01$) is within the
...
{\bf We build a complete cosmological sample of galaxy clusters from the
  ...
  even signal a deviation from the assumed self-similar redshift evolution.
