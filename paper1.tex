...
%{\bf As a cautionary remark, we emphasize that our model is only valid within
%$R_{500}$ and more work is needed to extrapolate it to larger cluster
%radii, \qc{particularly for the thermal modeling}.
{\bf As a cautionary remark, \qc{we emphasize that our model is built
to be valid within $R_{500}$ and more work is needed to extrapolate it to 
larger cluster radii, particularly for the thermal modeling}.
Those cluster regions are characterized by a steadily increasing level
of kinetic-to-thermal pressure support \citep[e.g.,][]{2009ApJ...705.1129L,
2012ApJ...758...74B}, density clumping \citep{2011ApJ...731L..10N,
2012arXiv1209.4082B}, and asphericity and ellipticity of the halo
morphologies \citep{2012arXiv1209.4082B}, in particular beyond the virial
radius where the filamentary cosmic web connects to the cluster interiors.}
...
\hline\\[-0.5em]
 ...
 0.53 & $-27.67\pm0.11$ & $1.59\pm0.01$ & 0.109\\
 0.61 & $-27.59\pm0.13$ & $1.59\pm0.01$ & 0.109\\ 
 0.78 & $-27.26\pm0.18$ & $1.58\pm0.01$ & 0.109\\ 
 1      & $-27.16\pm0.26$ & $1.58\pm0.02$ & 0.109\\[0.5em] 
\hline
\end{tabular}
\label{tab:YSZfits}
\end{center}
...
{\bf In the right panel of Fig.~\ref{fig:SZ_M}, we compare our scaling relation
  to the \qc{recent Atacama Cosmology Telescope (ACT) sample} \citep{2013JCAP...07..008H}, 
  which has a median redshift of $z=0.53$. 
  Again, the slope of our modeled scaling relation is somewhat shallower in comparison
  ...
  $Y_{500}$ estimates. This could also indicate that our presented
  ...
  in comparison to the {\em Planck} sample). 
  \qc{However, note that our scaling relation at $z=0.53$ ($A=-27.67\pm0.11$, $B=1.59\pm0.01$) 
  is perfectly compatible within the errors with the one derived from the ACT sample 
  ($A=-28.59\pm2.26$, $B=1.65\pm0.15$).  
  Therefore, we conclude that overall} there is reasonable
...
%However, there are some notable deviations among the different observational
  However, there are \qc{some deviations} among the different observational
  ...
  self-similar redshift evolution. \qc{Nevertheless, we stress that our scaling relation
  is still compatible within the errors of the ACT one.} 
